      ...
      <section id="cases" className="py-28 lg:py-36 bg-surface-white">
        <div className="max-w-[1240px] mx-auto px-6 lg:px-12">
          ...
          <div className="space-y-0">
            {[
              { cat: "온라인 교육", name: "온라인 교육 브랜드 A", quote: "카페 회원 7만 명의 커뮤니티를 가진 온라인 교육 브랜드. 업계 평균의 3배 이상인 CTR 3.93%를 달성하며, 한정된 예산으로도 높은 전환 효율을 증명했습니다.", person: "광고 성과 기준" },
              { cat: "B2B 지식 서비스", name: "B2B 지식 서비스 브랜드", quote: "고단가 B2B 지식 상품을 단 4천만 원 예산으로 ROAS 500%를 달성했습니다. '팔기 어려운 상품'도 메시지 설계가 정확하면 팔린다는 것을 보여준 사례입니다.", person: "ROAS 500% 달성" },
              { cat: "오프라인 교육", name: "오프라인 교육 브랜드", quote: "단일 지점에서 시작해 4개 신규 지점을 오픈하며 매출을 6.6배 성장시켰습니다. 무형의 교육 서비스를 지역 기반으로 확장한 대표 사례입니다.", person: "매출 6.6배 성장" },
              { cat: "가맹 네트워크", name: "가맹 네트워크 브랜드", quote: "전국 7개 지점의 가맹 네트워크를 마케팅으로 확장한 프로젝트입니다. 브랜드 통일성을 유지하면서 각 지역에 맞는 메시지를 설계해 전국 커버리지를 완성했습니다.", person: "전국 7개 지점 확장" },
            ].map((c) => (
              <Reveal key={c.name}>
