        ...
        <div className="relative z-10 max-w-[1200px] mx-auto w-full px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8">
              ...
              <p className="text-[17px] text-cream/65 leading-[2] max-w-[560px] mb-12 opacity-0 animate-fade-up stagger-3">
      ...
      <section className="py-28 lg:py-36">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
          ...
          <Reveal className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-14 items-start">
            <div className="lg:col-span-8">
              <p className="text-[16px] text-t-secondary leading-[2.1] mb-7">
              ...
              <p className="text-[16px] text-t-secondary leading-[2.1]">
          ...
          <Reveal className="mt-20 grid grid-cols-2 lg:grid-cols-4 gap-0">
            {[
              ...
              <div key={p.num} className="border-t border-border pt-7 pr-8 pb-7">
                <span className="text-[12px] font-display text-gold tracking-[0.1em]">{p.num}</span>
                <h3 className="font-accent text-[16px] font-bold text-t-strong mt-3 mb-3">{p.title}</h3>
                <p className="text-[14px] text-t-secondary leading-[1.9]">{p.body}</p>
              </div>
            ))}
          </Reveal>
        </div>
      ...
      <section className="py-28 lg:py-36 bg-dark">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
          <Reveal>
            ...
            <p className="text-[15px] text-cream/50 mt-4 max-w-[580px] leading-[2]">
          ...
          <Reveal className="mt-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-lg overflow-hidden">
              ...
              <div className="bg-cream/4 p-10 lg:p-12 flex flex-col justify-center">
                ...
                <p className="text-[15px] text-cream/55 leading-[2] mb-5">
                  Meta(Facebook · Instagram), Google, 토스애즈, 당근마켓, TikTok 등 주요 광고 플랫폼을 활용합니다. 단순히 광고를 많이 돌리는 게 아니라, <strong className="text-cream/85 font-medium">'구매 의향이 있는 사람'을 정밀하게 찾아내는 것</strong>이 핵심입니다.
                </p>
                <p className="text-[15px] text-cream/55 leading-[2] mb-7">
          ...
          <Reveal className="mt-5">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-lg overflow-hidden">
              <div className="bg-cream/4 p-10 lg:p-12 flex flex-col justify-center order-2 lg:order-1">
                ...
                <p className="text-[15px] text-cream/55 leading-[2] mb-5">
                  강사의 목소리, 공간의 공기, 수강생의 표정 — 무형을 파는 일은 결국 <strong className="text-cream/85 font-medium">감각을 번역하는 일</strong>입니다. 브랜디드 유튜브와 숏폼을 통해 브랜드 고유의 서사를 영상으로 만들고, 24시간 일하는 영업사원을 만듭니다.
                </p>
                <p className="text-[15px] text-cream/55 leading-[2] mb-7">
          ...
          <Reveal className="mt-5 grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <Link key={s.num} to={s.href} className="group block rounded-lg overflow-hidden hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="bg-cream/4 p-7">
                  <span className="text-[11px] font-bold tracking-[0.08em] uppercase text-gold">{s.num}</span>
                  <h3 className="text-[17px] font-medium text-cream/90 mt-2 mb-1">{s.name}</h3>
                  <p className="text-[12px] text-cream/35 mb-3">{s.sub}</p>
                  <p className="text-[14px] text-cream/55 leading-[1.9]">{s.desc}</p>
                  <span className="inline-flex items-center gap-1.5 text-[13px] text-gold mt-5 group-hover:translate-x-1 transition-transform">
      ...
      <section id="cases" className="py-28 lg:py-36">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
          <Reveal>
            ...
            <p className="text-[15px] text-t-tertiary mt-4 max-w-[540px] leading-[2]">
          ...
          <Reveal className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              <div key={i} className={`p-8 rounded-lg ${c.dark ? "bg-dark" : "bg-card shadow-card"}`}>
                <span className={`text-[11px] font-bold tracking-[0.08em] uppercase ${c.dark ? "text-gold" : "text-t-disabled"}`}>{c.cat}</span>
                <h3 className={`font-serif text-[24px] font-normal mt-3 mb-3 ${c.dark ? "text-cream/90" : "text-t-strong"}`}>{c.name}</h3>
                <p className={`text-[14px] leading-[1.9] mb-6 ${c.dark ? "text-cream/50" : "text-t-secondary"}`}>{c.desc}</p>
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
          ...
          <Reveal className="mt-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0">
            {[
              ...
              <div key={p.s} className="border-t-2 border-gold pt-7 pr-8 pb-7">
                <span className="text-[12px] font-display text-gold tracking-[0.1em]">{p.s}</span>
                <h3 className="text-[16px] font-medium text-t-strong mt-3 mb-3">{p.t}</h3>
                <p className="text-[14px] text-t-secondary leading-[1.9]">{p.d}</p>
              </div>
            ))}
          </Reveal>
        </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
          ...
          <Reveal className="mt-14 grid grid-cols-1 lg:grid-cols-3 gap-10">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-[16px] font-medium text-t-strong mb-3">전략 · 기획</h3>
              <p className="text-[14px] text-t-secondary leading-[1.9]">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-[16px] font-medium text-t-strong mb-3">퍼포먼스 · 데이터</h3>
              <p className="text-[14px] text-t-secondary leading-[1.9]">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-[16px] font-medium text-t-strong mb-3">크리에이티브 · 웹빌드</h3>
              <p className="text-[14px] text-t-secondary leading-[1.9]">
      ...
      <section id="contact" className="py-28 lg:py-36 bg-dark">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
          <Reveal>
            ...
            <p className="text-[15px] text-cream/50 mt-4 max-w-[500px] leading-[2] mb-10">
