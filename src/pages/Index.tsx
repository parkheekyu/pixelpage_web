          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="flex items-center gap-4 mb-14 opacity-0 animate-fade-up stagger-4">
                <Link to="/#contact" className="inline-flex items-center gap-2 px-8 py-3.5 bg-primary text-primary-foreground text-[14px] font-medium tracking-[0.02em] hover:bg-gold-light transition-all rounded-md">
                  무료 상담 신청
                </Link>
                <Link to="/#cases" className="inline-flex items-center px-7 py-3.5 border border-border text-[14px] text-muted-foreground hover:text-foreground hover:border-foreground/30 transition-colors rounded-md">
                  성과 보기
                </Link>
              </div>
            </div>
            <div className="hidden lg:flex justify-center items-center relative h-[480px]">
              <div className="absolute top-0 right-8 animate-float stagger-2">
                <div className="blob-shape-1 w-[190px] h-[190px] overflow-hidden shadow-card">
              ...
              <div className="absolute bottom-4 right-16 animate-float stagger-4">
                <div className="blob-shape-2 w-[210px] h-[230px] overflow-hidden shadow-card">
              ...
              <div className="absolute top-[30%] left-0 animate-float stagger-6">
                <div className="blob-shape-3 w-[170px] h-[190px] overflow-hidden shadow-card">
              ...
              <Reveal key={s.num}>
                <Link to={s.href} className={`group grid grid-cols-1 lg:grid-cols-2 gap-10 items-center py-10 border-t border-border transition-colors ${i % 2 === 1 ? 'lg:direction-rtl' : ''}`}>
                  ...
                  <div className={`flex justify-center ${i % 2 === 1 ? 'lg:order-1' : ''}`}>
                    <img src={s.img} alt={s.name} className="w-[260px] lg:w-[300px] group-hover:scale-105 transition-transform duration-500" loading="lazy" width={800} height={640} />
                  </div>
                </Link>
              </Reveal>
            ))}
