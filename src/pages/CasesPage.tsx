...
const cases = [
  { name: "온라인 교육 브랜드 A", cat: "온라인 교육", stats: [{ n: "70,000", u: "+", l: "카페 회원" }, { n: "3.93", u: "%", l: "CTR" }] },
  { name: "B2B 지식 서비스 브랜드", cat: "B2B 지식 서비스", stats: [{ n: "500", u: "%", l: "ROAS" }, { n: "40", u: "M", l: "집행 금액" }] },
  { name: "오프라인 교육 브랜드", cat: "오프라인 교육", stats: [{ n: "6.6", u: "×", l: "매출 성장" }, { n: "4", u: "+", l: "신규 지점" }] },
  { name: "가맹 네트워크 브랜드", cat: "가맹 네트워크", stats: [{ n: "7", u: "+", l: "전국 지점" }, { n: "전국", u: "", l: "커버리지" }] },
];
